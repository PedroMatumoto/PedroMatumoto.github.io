    ...
    filmes: {
        ...
        items: [
            ...
            },
            {
                ...
                year: "2011",
                creator: "Olivier Nakache, Éric Toledano",
                cover: "",
            ...
            },
            {
                title: "Coco",
                year: "2017",
                creator: "Lee Unkrich, Adrian Molina",
                cover: "",
                genres: ["Animation", "Adventure", "Family"],
                status: "planned",
                rating: 0,
            ...
            },
            {
                title: "Brother Bear",
                year: "2003",
                creator: "Aaron Blaise, Robert Walker",
                cover: "",
                genres: ["Animation", "Adventure", "Family"],
                status: "consumed",
                rating: 10,
            ...
            },
            {
                title: "Up",
                year: "2009",
                creator: "Pete Docter, Bob Peterson",
                cover: "",
                genres: ["Animation", "Adventure", "Comedy"],
                status: "consumed",
                rating: 10,
...
export interface RecipeReferenceLink {
  label: string;
  url: string;
  description?: string;
}

export const receitasReferenceLinks: RecipeReferenceLink[] = [
  {
    label: "Drew Eats",
    url: "https://drew-eats.com/",
    description: "Receitas",
  },
  {
    label: "Issa Grill",
    url: "https://issagrill.jupiter.recipes/",
    description: "Receitas",
  }
];
...
export const receitasData: Recipe[] = [
  ...
  {
    slug: "macarrao-queijo",
    name: "Macarrão ao queijo",
    timeMin: 40,
    tags: ["italiano", "massa"],
    image: "",
    ingredients: [
      ...
      "3 colheres de sopa de bacon dourado",
      "1 colher de sopa de manteiga sem sal",
      "Sal e pimenta a gosto",
    ],
    steps: [
      "Coloque o azeite e o alho em uma panela e refogue",
      "Adicione o macarrao e o caldo, creme de leite, cream cheese, queijo ralado, salsinha, bacon e manteiga",
    ],
  },
  {
    slug: "oyakodon-panela-de-arroz",
    name: "Oyakodon (Frango e Ovo) na Panela de Arroz",
    timeMin: 40,
    tags: ["asiático", "jantar", "prático"],
    image: "",
    ingredients: [
        "1 xícara de arroz + a quantidade de água que você usa normalmente",
        "450g de sobrecoxa de frango, cortada em cubos",
        "1/4 de cebola amarela, fatiada finamente",
        "1 colher de sopa de shoyu (molho de soja)",
        "1 colher de chá de hondashi",
        "1 colher de chá de mirin",
        "Uma pitada de açúcar",
        "2 a 3 ovos",
        "Cebolinha e sementes de gergelim para decorar",
    ],
    steps: [
        "Lave o arroz e adicione à panela elétrica de arroz com a água",
        "Em uma tigela, misture o shoyu, o hondashi, o mirin e o açúcar",
        "Adicione o frango e a cebola à tigela e misture para cobrir com o molho",
        "Coloque a mistura de frango e cebola diretamente sobre o arroz na panela elétrica, despejando todo o molho restante. Reserve a tigela",
        "Cozinhe o arroz normalmente. Enquanto isso, na tigela reservada, bata os ovos levemente com um garfo ou hashi por apenas 20 segundos",
        "Logo após o arroz ficar pronto, abra a panela, despeje os ovos sobre o frango e o arroz e feche rapidamente. Ligue a panela novamente e cozinhe por 2 minutos",
        "Abra a panela, sirva e decore com cebolinha e gergelim torrado",
    ],
    },
    {
        slug: "macarrao-creme-batata",
        name: "Macarrão ao Creme de batata",
        timeMin: 40,
        tags: ["asiático", "jantar", "prático"],
        image: "",
        ingredients: [
            "300g de peito de frango temperado (sal, pimenta, páprica e lemon pepper)",
            "150g de bacon e 200g de mussarela (mas pode colocar a gosto)",
            "300g de macarrão cru",
            "2 batatas",
            "1 creme de leite",
            "1 copo de requeijão cremoso",
            "Leite apenas para ajudar a bater o molho",
            "Fio de óleo",
            "1 cebola",
            "Sal",
            "Temperos a gosto",
        ...
        steps: [
            "Cozinhar as batatas",
            "Refogar as cebolas e adicionar o frango, ao mesmo tempo que frita o bacon e ferve o macarrão",
            "Bater as batatas com o creme de leite, requeijão e um pouco de leite para ajudar a bater",
            "Coloque o creme de batata no frango, adicione o macarrão e misture tudo, e coloque queijo por cima",
        ],
    },
    {
        slug: "gelatina-cafe",
        ...
        steps: [
            "Hidrate a gelatina em meio copo de água, misture e deixe de lado por 5 minutos",
            "Misture o café com o açúcar até dissolver e misture com a gelatina hidratada",
            "Reserve, coloque na geladeira e espere por no mínimo 4 horas",
            "Misture o creme de leite e o doce de leite para a cobertura",
        ]
    },
    {
        slug: "macarrao-alho-assado-cebola-caramelizada",
        name: "Macarrão com Alho Assado e Cebola Caramelizada",
        timeMin: 65,
        tags: ["massa", "conforto", "jantar"],
        image: "",
        ingredients: [
            "300g de macarrão espaguete ou linguine",
            "1 cabeça de alho",
            "3 cebolas",
            "200g de creme de leite fresco",
            "Azeite",
            "50g de manteiga",
            "Queijo Grana Padano ou Parmesão ralado a gosto",
            "Cebolinha ou tomilho fresco para finalizar (opcional)",
            "Sal e pimenta-do-reino a gosto"
        ],
        steps: [
            "Corte a parte de cima da cabeça de alho, tempere com sal, pimenta-do-reino e um fio de azeite. Embrulhe no papel alumínio e leve ao forno ou airfryer a 200°C por 50 a 60 minutos",
            "Corte as cebolas e coloque para dourar em uma panela com azeite e manteiga até caramelizar",
            "Coloque o macarrão para cozinhar em outra panela com água fervente e sal por 8 a 9 minutos (ou até ficar al dente)",
            "Esprema o alho assado na panela com as cebolas caramelizadas, ligue o fogo e adicione o creme de leite fresco",
            "Misture bem e acrescente 2 conchas da água do cozimento do macarrão",
            "Adicione a massa à panela do molho e misture tudo. Finalize com o queijo ralado e tomilho ou cebolinha picada"
        ]
    },
    {
        slug: "panqueca-de-batata-com-queijo",
        name: "Panqueca de Batata Recheada com Queijo",
        timeMin: 40,
        tags: ["lanche", "batata", "conforto"],
        image: "",
        ingredients: [
            "600g de batata",
            "70g de amido de milho",
            "1 colher de sopa de açúcar",
            "1 colher de sopa de sal (opcional)",
            "200g de queijo mussarela ralado",
            "Manteiga para fritar"
        ],
        steps: [
            "Lave, descasque e pique as batatas. Leve para cozinhar em água com o sal",
            "Assim que estiverem bem cozidas, retire da água e amasse-as ainda quentes",
            "Com o purê lisinho, adicione o amido de milho e o açúcar. Mexa muito bem até ficar uma massa completamente homogênea",
            "Pegue uma mão cheia do purê, abra na mão e coloque o queijo ralado no centro. Feche a massa e achate levemente para parecer uma panqueca",
            "Frite em uma frigideira com manteiga em fogo baixo até dourar dos dois lados, dando tempo para o queijo derreter por dentro"
        ]
    },
    {
        slug: "hayashi-rice",
        name: "Hayashi Rice (Picadinho Japonês com Cogumelos)",
        timeMin: 40,
        tags: ["japonês", "carne", "conforto"],
        image: "",
        ingredients: [
            "1 colher de sopa de óleo neutro",
            "1 cebola média, fatiada",
            "450g de contrafilé (rib eye), fatiado fino",
            "2 cogumelos marrons (ex: portobello), fatiados",
            "Pitada de sal",
            "Pitada de pimenta-do-reino",
            "500ml de água",
            "4 cubos de preparado para Hayashi Rice (marca S&B ou similar)",
            "4 xícaras de arroz japonês (para sushi) cozido, para servir",
            "Brócolis cozido no vapor, para servir",
            "2 colheres de chá de creme de leite fresco"
        ],
        steps: [
            "Aqueça o óleo neutro em uma panela média em fogo médio",
            "Adicione a cebola e refogue até ficar perfumada, cerca de 1 minuto",
            "Adicione a carne fatiada, aumente o fogo para médio-alto e cozinhe até dourar dos dois lados, cerca de 4 minutos",
            "Adicione os cogumelos, sal e pimenta. Reduza o fogo para médio",
            "Assim que os cogumelos estiverem levemente macios (cerca de 3 minutos), adicione a água e tampe a panela",
            "Reduza o fogo para médio-baixo para manter uma fervura branda. Cozinhe por cerca de 20 minutos ou até a carne ficar macia, retirando a espuma da superfície ocasionalmente",
            "Adicione os cubos de Hayashi Rice e mexa até dissolver completamente",
            "Continue cozinhando sem a tampa para reduzir o molho até formar um caldo grosso, cerca de 5 minutos",
            "Sirva imediatamente acompanhado do arroz cozido, brócolis e finalize com um fio de creme de leite fresco por cima"
        ]
    },
    {
        slug: "tortilla-de-maca-com-canela",
        ...
        ingredients: [
            ...
            "1/2 colher de chá de canela em pó (para o recheio)",
            "Tortillas (tamanho médio ou grande)",
            "Água (um pouco para o recheio e para umedecer as bordas)",
            "Manteiga derretida para pincelar",
            "Açúcar e canela a gosto para polvilhar"
        ],
        steps: [
            "Em uma panela, coloque as maçãs picadas, o açúcar e o suco de limão. Leve ao fogo médio e cozinhe até começarem a amolecer",
            "Adicione um pouquinho de água e continue cozinhando por alguns minutos",
            "Dissolva o amido de milho em um pouco de água, acrescente à panela e mexa sem parar até engrossar e formar um creme",
            "Finalize o recheio com a meia colher de chá de canela, misture bem e deixe esfriar",
            "Para a montagem, coloque uma porção do recheio já frio no centro de cada tortilla",
            "Dobre como um burrito: feche as laterais para dentro e enrole apertando bem. Umedeça a borda final com um pouco de água para selar",
            "Pincele os burritos com a manteiga derretida e polvilhe a mistura de açúcar com canela por toda a parte externa",
            "Leve à airfryer a 180°C por cerca de 7 minutos, ou até ficarem dourados e crocantes"
        ]
    }
];
